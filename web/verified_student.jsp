...
<%@include file="header.jsp"%>
    ...
    <%@include file="faculty_nav.jsp"%>
        <% FacultyDAO ob=new FacultyDAO();
                           ...
                           List<InternshipDetailsBean> intern_list=ob.displayVerifiedStudents(sec,dept);
                    ...
                    <div class="card-body">
                        ...
                        <form action="filter" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" value="verified" name="ch">      
                            </div>
            ...
            <div class="col-12 col-sm-10 justify-content-center" style="padding-bottom: 100px;">
                        ...
                        %>
                            ...
                            <td><form action="rejectDetails" method="post">
                                ...
                                <input type="hidden" name="user" value="fac">
                                <input type="hidden" name="type" value="ver">
                                </form></td>
                            </tr>
                             <%}
                       }%>
